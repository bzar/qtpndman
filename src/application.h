...
namespace QPndman
{
  ...
  private:
    ...
    QList<License> _licenses;
    QList<PreviewPicture> _previewPictures;
    QList<Category> _categories;
    QList<Association> _associations;
