...
namespace QPndman
{
  ...
  Q_OBJECT
    ...
    Q_PROPERTY(Version* osVersion READ getOsversion CONSTANT)
    Q_PROPERTY(Version* version READ getVersion CONSTANT)
    Q_PROPERTY(ExecutionInfo* executionInfo READ getExecutioninfo CONSTANT)
    Q_PROPERTY(DocumentationInfo* documentationInfo READ getDocumentationinfo CONSTANT)
    ...
    Q_PROPERTY(QList<License*> licenses READ getLicenses CONSTANT)
    Q_PROPERTY(QList<PreviewPicture*> previewPictures CONSTANT)
    Q_PROPERTY(QList<Category*> categories READ getCategories CONSTANT)
    Q_PROPERTY(QList<Association*> associations READ getAssociations CONSTANT)
